...
| Set<T> union(const Set<T>& other) const        | Виконує операцію об'єднання двох множин. Повертає нову множину, що містить всі унікальні елементи поточної множини та множини `other`. |
| Set<T> intersection(const Set<T>& other) const | Виконує операцію перетину двох множин. Повертає нову множину, що містить тільки елементи, які одночасно належать обом множинам.        |
