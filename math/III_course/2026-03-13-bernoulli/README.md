...
Формула Бернуллі або біноміальний розподіл описує схему, коли незалежне випробування повторюється $n$ разів з однаковою ймовірністю успіху $p$. Коефіцієнт $\binom{n}{k}$ показує кількість різних способів вибрати $k$ успіхів серед $n$ випробовувань.
