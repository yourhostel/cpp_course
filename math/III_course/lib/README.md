...
StatKit це легка header only бібліотека для роботи зі статистичними розподілами, 
яка побудована як строго типізована надбудова над Boost.Math. 
Вона не замінює Boost, а використовує його як обчислювальне ядро, додаючи контроль інваріантів, 
